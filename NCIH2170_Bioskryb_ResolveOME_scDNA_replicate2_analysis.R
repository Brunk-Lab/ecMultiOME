...
#This is the second plate that we sequenced:
rds1 <- readRDS("/datastore/lbcfs/labs/brunk_lab/unc-external-downloads/bioskryb_UNC_BrunkGroup/AAG7YVWM5-OMEV2384-Beta---Brunk-Plate-2/2024_12_10T15_31_18/bj-dna-qc_2.0.3_241119_81657/tertiary_analyses/cnv_ginkgo/ginkgo_res.binsize_1000000.RDS")
...
write.csv(df1, "/home/yue1118/Bioskryb_data_analysis/NCIH2170_plate2_ecDNA_counts_03252025.csv")
...
svg('/home/yue1118/Bioskryb_data_analysis/Bioskryb_plots_for_FACS_FISH_paper/MYC_copy_number_plate2_by_scDNA_seq_03252025.svg',width = 6, height = 6)
barplot(df1$chr8_copy_number)
dev.off()

#To plot ecDNA counts distribution across single cells
svg('/home/yue1118/Bioskryb_data_analysis/Bioskryb_plots_for_FACS_FISH_paper/ecDNA_counts_distribution_plate2_by_scDNA_seq_0325025.svg',width = 6, height = 6)
...
ggplot(df1, aes(x = `phenotype`, y = `ecDNA_cn`)) +
  ...
  theme_minimal()
ggsave('/home/yue1118/Bioskryb_data_analysis/Bioskryb_plots_for_FACS_FISH_paper/ecDNA_counts_plate2_boxplot_high_med_low_NCIH2170_03252025.svg', width = 6, height = 6)

wilcox.test(df1[df1$phenotype =="High","ecDNA_cn"], df1[df1$phenotype =="Low","ecDNA_cn"], paired = F) #p-value = 5.303e-14
wilcox.test(df1[df1$phenotype =="High","ecDNA_cn"], df1[df1$phenotype =="Med","ecDNA_cn"], paired = F) #p-value = 0.002298
wilcox.test(df1[df1$phenotype =="Med","ecDNA_cn"], df1[df1$phenotype =="Low","ecDNA_cn"], paired = F) #p-value = 0.001555




#To compare inferred ecDNA counts with FISH imaging ecDNA counts
#If we include only the "control 2170" cells to compare with Bioskryb data
df_inferred_ecDNA <- read.csv("/home/yue1118/Bioskryb_data_analysis/NCIH2170_plate2_ecDNA_counts_03252025.csv")
...
ggplot(df3, aes(x = `technique`, y = `ecDNA_cn`)) +
  ...
  labs(x = "Grouping Variable", y = "Value", title = "Boxplot by Group") +
  theme_minimal()
ggsave('/home/yue1118/Bioskryb_data_analysis/Bioskryb_plots_for_FACS_FISH_paper/ecDNA_counts_plate2_boxplots_Bioskryb_vs_all_control_MYC_and_ERBB2_colocalized_ecDNA_NCIH2170_FISH_03252025.svg', width = 6, height = 6)

wilcox.test(df1$ecDNA_cn, df2$ecDNA_cn) #p-value = 0.04688
